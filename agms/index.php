   ...
   <body>
                        ...
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p style="color:red; font-size:3vw; text-shadow: 2px 2px 8px #000000;"><b>Founded by Abhishek and Chejring</b></p>
                              </div>
                     ...
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p style="color:lightskyblue;font-size:3vw; text-shadow: 2px 2px 8px #000000;"><b>Founded by Abhishek and Chejring</b></p>
                              </div>
                              <div class="outs_more-buttn">
                                 <a href="about.php">Read More</a>
                              </div>
                     ...
                     <div class="slider-img three-img">
                        <div class="container">
                           <div class="slider-info">
                              ...
                              <div class="bottom-info">
                                 <p style="color:yellow;font-size:3vw; text-shadow: 2px 2px 8px #000000;"><b>Founded by Abhishek and Chejring</b></p>
                              </div>
                              <div class="outs_more-buttn">
                                 <a href="about.php">Read More</a>
                              </div>
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="images1.jpg" width="400" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Sculptures</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="6wwsgzazcaw51.jpg" width="400" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Serigraphs</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <img src="genshin_impact_hu_tao_transparent_png_by_vent1slyre_deqclqu-pre.png" width="400" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Prints</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="Fta8nI6agAU3OWi.jpg" width="400" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Painting</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="download.jpg" width="400" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Street Art</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <img src="maxresdefault.jpg" width="500" height="400" class="img-thumbnail" alt="">
                  <div class="banner-right-icon">
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">More Arts</h3>
            <div class="slid-img">
               <ul id="flexiselDemo1">
                  <?php
