            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.php">Online Art Platform</a></h1>
                  </div>
               </div>
            </div>
...
?>
                     ...
                     <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="admin/login.php" class="nav-link">Customer</a>
                     </li>
                     <!--<li class="nav-item">
                        <a href="admin/login1.php" class="nav-link">Artist</a>
                     </li> -->
                  </ul>
               </div>
            </nav>
